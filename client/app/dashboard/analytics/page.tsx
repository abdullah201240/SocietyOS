          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-2 border-b border-zinc-200/60 dark:border-zinc-800/60">
            ...
            <div className="flex items-center gap-2 self-start sm:self-auto">
              <Button
                ...
                className="h-8 rounded-sm text-[11px] font-semibold border-zinc-200 hover:bg-zinc-50 dark:border-zinc-850 dark:hover:bg-zinc-900 text-zinc-700 dark:text-zinc-350 cursor-pointer shadow-sm"
              >
                Compare Buildings
              </Button>
              <Button
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card className="rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-850 dark:bg-zinc-950 p-4">
                  <div className="flex items-center gap-1 border-b border-zinc-100 pb-2 mb-3.5 dark:border-zinc-900">
                  ...
                  <div className="space-y-3 text-xs">
                    ...
                    <div className="pt-2 border-t border-zinc-100 dark:border-zinc-900 flex justify-between text-[10px] text-zinc-450 uppercase font-bold">
                ...
                <Card className="rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-850 dark:bg-zinc-950 p-4">
                  ...
                  <div className="space-y-3.5">
                    ...
                    <div className="flex justify-between text-[10px] text-zinc-450 border-t border-zinc-100 pt-2 dark:border-zinc-900">
