        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-5 scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-800">
          ...
          <Tabs defaultValue="org" className="w-full">
            <TabsList className="flex flex-wrap h-auto gap-1 border-b border-zinc-200 dark:border-zinc-850 bg-transparent justify-start p-0 mb-4 rounded-none">
              <TabsTrigger value="org" className="h-9 text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-indigo-600 data-[state=active]:bg-transparent px-3 font-semibold">
                <Building className="h-3.5 w-3.5 mr-1.5" /> Organization
              </TabsTrigger>
              <TabsTrigger value="roles" className="h-9 text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-indigo-600 data-[state=active]:bg-transparent px-3 font-semibold">
                <Lock className="h-3.5 w-3.5 mr-1.5" /> Roles & Permissions
              </TabsTrigger>
              <TabsTrigger value="billing" className="h-9 text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-indigo-600 data-[state=active]:bg-transparent px-3 font-semibold">
                <CreditCard className="h-3.5 w-3.5 mr-1.5" /> Billing Config
              </TabsTrigger>
              <TabsTrigger value="notifications" className="h-9 text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-indigo-600 data-[state=active]:bg-transparent px-3 font-semibold">
                <Bell className="h-3.5 w-3.5 mr-1.5" /> Notifications
              </TabsTrigger>
              <TabsTrigger value="utilities" className="h-9 text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-indigo-600 data-[state=active]:bg-transparent px-3 font-semibold">
                <Zap className="h-3.5 w-3.5 mr-1.5" /> Utilities
              </TabsTrigger>
              <TabsTrigger value="security" className="h-9 text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-indigo-600 data-[state=active]:bg-transparent px-3 font-semibold">
                <Fingerprint className="h-3.5 w-3.5 mr-1.5" /> Security Rules
              </TabsTrigger>
              <TabsTrigger value="integrations" className="h-9 text-xs rounded-none border-b-2 border-transparent data-[state=active]:border-indigo-600 data-[state=active]:bg-transparent px-3 font-semibold">
            ...
            <TabsContent value="org" className="space-y-4">
              <Card className="border border-zinc-200 bg-white dark:border-zinc-850 dark:bg-zinc-950 max-w-2xl rounded-md shadow-sm">
                ...
                <CardContent className="p-4 space-y-4">
                  <div className="grid grid-cols-3 items-center gap-4">
                    ...
                    <Input value={societyName} onChange={(e) => setSocietyName(e.target.value)} className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200" />
                  </div>
                  <div className="grid grid-cols-3 items-center gap-4">
                    <Label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Address Location</Label>
                    <Input value={societyAddress} onChange={(e) => setSocietyAddress(e.target.value)} className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200" />
                  </div>
                  <div className="grid grid-cols-3 items-center gap-4">
                    <Label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Timezone</Label>
                    <Input value={timezone} onChange={(e) => setTimezone(e.target.value)} className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200" />
                  </div>
            ...
            <TabsContent value="roles" className="space-y-4">
              <Card className="border border-zinc-200 bg-white dark:border-zinc-850 dark:bg-zinc-950 max-w-2xl rounded-md shadow-sm">
                ...
                <CardContent className="p-4 space-y-3.5 text-xs">
                  <div className="flex justify-between items-center border-b border-zinc-100 pb-2.5 dark:border-zinc-900">
                    <div>
                    ...
                    <Badge className="bg-indigo-50 text-indigo-700 border-indigo-200 dark:bg-indigo-950/20 dark:text-indigo-400">All Privileges</Badge>
                  </div>
                  <div className="flex justify-between items-center border-b border-zinc-100 pb-2.5 dark:border-zinc-900">
                    <div>
                    ...
                    <Badge variant="outline" className="text-[9px] border-zinc-200">Gate Scope Only</Badge>
                  </div>
                  <div className="flex justify-between items-center border-b border-zinc-100 pb-2.5 dark:border-zinc-900">
                    <div>
                    ...
                    <Badge variant="outline" className="text-[9px] border-zinc-200">Wrench Scope</Badge>
                  </div>
                  <div className="flex justify-end pt-2">
              ...
              <Card className="border border-zinc-200 bg-white dark:border-zinc-850 dark:bg-zinc-950 max-w-2xl rounded-md shadow-sm">
                ...
                <CardContent className="p-4 space-y-4">
                  <div className="grid grid-cols-3 items-center gap-4">
                    ...
                    <Input type="number" value={lateFeeAmount} onChange={(e) => setLateFeeAmount(Number(e.target.value))} className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200" />
                  </div>
                  <div className="grid grid-cols-3 items-center gap-4">
                    <Label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Billing Run Cycle</Label>
                    <select value={billingCycle} onChange={(e) => setBillingCycle(e.target.value)} className="col-span-2 h-8.5 text-xs rounded-sm border border-zinc-205 bg-white px-2 dark:border-zinc-800 dark:bg-zinc-900 outline-none">
              ...
              <Card className="border border-zinc-200 bg-white dark:border-zinc-850 dark:bg-zinc-950 max-w-2xl rounded-md shadow-sm">
                ...
                <CardContent className="p-4 space-y-4 text-xs">
                  <div className="flex justify-between items-center border-b border-zinc-100 pb-2.5 dark:border-zinc-900">
                    ...
                    <input type="checkbox" checked={smsAlerts} onChange={(e) => setSmsAlerts(e.target.checked)} className="h-4 w-4 rounded border-zinc-200 text-indigo-600 outline-none" />
                  </div>
                  <div className="flex justify-between items-center border-b border-zinc-100 pb-2.5 dark:border-zinc-900">
                    <div>
                    ...
                    <input type="checkbox" checked={emailNotifications} onChange={(e) => setEmailNotifications(e.target.checked)} className="h-4 w-4 rounded border-zinc-200 text-indigo-600 outline-none" />
                  </div>
                  <div className="flex justify-end pt-2">
              ...
              <Card className="border border-zinc-200 bg-white dark:border-zinc-850 dark:bg-zinc-950 max-w-2xl rounded-md shadow-sm">
                ...
                <CardContent className="p-4 space-y-4">
                  <div className="grid grid-cols-3 items-center gap-4">
                    ...
                    <Input type="number" step="0.01" value={electricityRate} onChange={(e) => setElectricityRate(Number(e.target.value))} className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200" />
                  </div>
                  <div className="grid grid-cols-3 items-center gap-4">
                    <Label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Water Consumption Rate ($/L)</Label>
                    <Input type="number" step="0.001" value={waterRate} onChange={(e) => setWaterRate(Number(e.target.value))} className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200" />
                  </div>
                  <div className="flex justify-end pt-2">
              ...
              <Card className="border border-zinc-200 bg-white dark:border-zinc-850 dark:bg-zinc-950 max-w-2xl rounded-md shadow-sm">
                ...
                <CardContent className="p-4 space-y-4 text-xs">
                  <div className="flex justify-between items-center border-b border-zinc-100 pb-2.5 dark:border-zinc-900">
                    ...
                    <input type="checkbox" checked={otpVerify} onChange={(e) => setOtpVerify(e.target.checked)} className="h-4 w-4 rounded border-zinc-200 text-indigo-600 outline-none" />
                  </div>
                  <div className="flex justify-end pt-2">
              ...
              <Card className="border border-zinc-200 bg-white dark:border-zinc-850 dark:bg-zinc-950 max-w-2xl rounded-md shadow-sm">
                ...
                <CardContent className="p-4 space-y-4">
                  <div className="grid grid-cols-3 items-center gap-4">
                    ...
                    <Input type="password" value="••••••••••••••••••••••••" readOnly className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200 bg-zinc-50" />
                  </div>
                  <div className="grid grid-cols-3 items-center gap-4">
                    <Label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Gate Cameras Webhook API</Label>
                    <Input value="https://api.societyos.com/v1/gate-stream" readOnly className="col-span-2 h-8.5 text-xs rounded-sm border-zinc-200 bg-zinc-50" />
                  </div>
                  <div className="flex justify-end pt-2">
