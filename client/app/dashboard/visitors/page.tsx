          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <Card className="rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-850 dark:bg-zinc-950">
              <CardContent className="p-3">
                ...
                <div className="mt-2 text-[10px] text-zinc-400">Total gate entry clearance check-ins</div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-850 dark:bg-zinc-950">
              <CardContent className="p-3">
                ...
                <div className="mt-2 text-[10px] text-zinc-400">Awaiting host resident confirmation</div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-850 dark:bg-zinc-950">
              <CardContent className="p-3">
                ...
                <div className="mt-2 text-[10px] text-zinc-400">Escalated access violations logs</div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-md border border-zinc-200 bg-white shadow-sm dark:border-zinc-850 dark:bg-zinc-950">
              <CardContent className="p-3">
                ...
                <div className="mt-2 text-[10px] text-zinc-400">E-commerce delivery checks</div>
              </CardContent>
            </Card>
          </div>
                  ...
                  {selectedVisitor.securityApprovalLog.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      {selectedVisitor.securityApprovalLog.map((log, idx) => (
                        <div key={idx} className="text-xs p-2 border border-zinc-150 rounded bg-zinc-50/50 dark:border-zinc-900">
                          {log}
                        </div>
                      ))}
                    </div>
