...
export function CTASection() {
  return (
    <section className="py-16 md:py-24 border-t border-zinc-100 dark:border-zinc-900 bg-zinc-50/20 dark:bg-black/30 overflow-hidden relative">
        ...
        <div className="border border-zinc-200/80 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/40 rounded-xl p-8 md:p-12 text-center max-w-4xl mx-auto shadow-xs">
          ...
          <div className="flex flex-col items-center max-w-2xl mx-auto">
            ...
            <div className="mt-8 flex flex-wrap gap-4 justify-center">
              ...
              <Button size="default" variant="outline" className="text-xs h-9.5 font-semibold px-5 rounded-md border-zinc-200 hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-900" asChild>
                <a href="#contact-sales">Contact Sales</a>
              </Button>
            </div>

            {/* Micro Operational Checkpoints */}
            <div className="mt-10 flex flex-wrap justify-center gap-x-8 gap-y-3 text-[10px] text-zinc-450 dark:text-zinc-505 font-medium border-t border-zinc-100 dark:border-zinc-900 pt-8 w-full">
