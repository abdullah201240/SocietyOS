    ...
    <section id="solutions" className="py-16 md:py-24 -100 bg-white dark:bg-black">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-7 left-16 right-16 h-0.5 -200 -z-10" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="relative flex flex-col items-start gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="lg:hidden h-0.5 flex-1 -200" />
              ...
              {/* Card content */}
              <div className="w-full flex-1 flex flex-col justify-between -200/80 bg-zinc-50/50 p-4 dark:bg-zinc-950/20">
                {/* Visual mini-mockup */}
                <div className="w-full h-36 rounded -150 bg-white p-3 mb-4 text-[10px] flex flex-col justify-between dark:bg-zinc-950">
                  <div className="flex items-center justify-between -100 pb-1.5">
                    <span className="font-semibold text-zinc-800 dark:text-zinc-200">New Complaint Form</span>
                    <Badge variant="outline" className="text-[7.5px] px-1 py-0-200 text-zinc-500">Unit 1204</Badge>
                  </div>
                  <div className="space-y-1.5 my-2">
                    <div className="space-y-0.5">
                      <span className="text-[7.5px] text-zinc-400">ISSUE TITLE</span>
                      <div className="px-1.5 py-1 rounded -100 bg-zinc-50/50 dark:bg-zinc-900/50 font-medium text-zinc-700 dark:text-zinc-300">
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1 space-y-0.5">
                        ...
                        <div className="px-1.5 py-0.5 rounded -100 bg-zinc-50/50 text-center font-semibold text-zinc-700 dark:bg-zinc-900/50 dark:text-zinc-350">
                          High
                        </div>
                      </div>
                      <div className="flex-1 space-y-0.5">
            ...
            <div className="relative flex flex-col items-start gap-4">
              ...
              <div className="w-full flex-1 flex flex-col justify-between -200/80 bg-zinc-50/50 p-4 dark:bg-zinc-950/20">
                ...
                <div className="w-full h-36 rounded -150 bg-white p-3 mb-4 text-[10px] flex flex-col justify-between dark:bg-zinc-950">
                  ...
                  <div className="space-y-1.5 my-2">
                    <div className="p-1.5 rounded -100 bg-zinc-50/50 dark:bg-zinc-900/50">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <div className="flex items-center justify-between px-1.5 py-1 rounded -100 bg-zinc-50/50 dark:bg-zinc-900/50 text-zinc-700 dark:text-zinc-350">
                  ...
                  <div className="space-y-1.5 my-2">
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5">
                        <input type="checkbox" checked disabled className="h-2.5 w-2.5 rounded text-zinc-800-300" />
                      ...
                      <div className="flex items-center gap-1.5">
                        <input type="checkbox" disabled className="h-2.5 w-2.5 rounded text-zinc-800-300" />
